#TODO: Figure out how to get these dependencies on Render/another Server
#TODO: ^pip, jupyter

# To Run Python Dependencies in Powershell: cd C:\Users\rhaye\AppData\Local\Microsoft\WindowsApps>
...
subprocess.call(['git', 'clone', 'https://github.com/effusiveperiscope/so-vits-svc', '-b', 'eff-4.0'])
os.chdir('so-vits-svc')
with open('requirements.txt', 'r') as f:
    for line in f.readlines():
        subprocess.call(['pip', 'install', line.strip(), '--extra-index-url', 'https://download.pytorch.org/whl/cu116'])
subprocess.call(['pip', 'install', 'praat-parselmouth'])
subprocess.call(['pip', 'install', 'ipywidgets'])
subprocess.call(['pip', 'install', 'huggingface_hub'])
subprocess.call(['pip', 'install', 'pip==23.0.1'])
subprocess.call(['pip', 'install', 'fairseq==0.12.2'])
#TODO: Fix Jupyter GUI if necessary?
# subprocess.call(['jupyter', 'nbextension', 'enable', '--py', 'widgetsnbextension'])
subprocess.call(['pip', 'install', 'numpy==1.21'])
subprocess.call(['pip', 'install', '--upgrade', 'protobuf==3.9.2'])
subprocess.call(['pip', 'uninstall', '-y', 'tensorflow'])
subprocess.call(['pip', 'install', 'tensorflow==2.11.0'])

print("Hairy Dairy pip!!!")

# print("Hairy Dairy Imports Succeeded!")
